<%@ Page Title="" Language="C#" MasterPageFile="~/sasecMaster.Master" AutoEventWireup="true" CodeBehind="exportarMemo.aspx.cs" Inherits="SASEC_IC.exportarMemo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id='cssmenu'>
       <ul style="color: #449BAF; background-color: #314E6E; font-family: 'Segoe UI Emoji'; font-size: medium;">
           ...
           <li style="width: 217px" ><a href='modificarMemo.aspx' style="width: 190px"><span>Modificar Memorandum</span></a></li>
           <li class='active'><a href='exportarMemo.aspx' style="width: 182px"><span>Exportar Memorandum</span></a></li>             
       </ul>
    </div>
    ...
    <div id="formMemo">
              ...
              <fieldset style="height: 684px">
                    ...
                    <br />
                    <asp:TextBox id="TextArea1" TextMode="multiline" Columns="50" Rows="5" runat="server" Height="333px" style="margin-left: 67px; margin-top: 37px" Width="879px" />
                    <br />
                    <br />
&nbsp;&nbsp;&nbsp;
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" Text="Nombre Del Archivo:"></asp:Label>
                    <asp:TextBox ID="TextBox6" runat="server" style="margin-left: 21px" Width="262px"></asp:TextBox>
                    <br />
                    <br />
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" style="margin-left: 434px" Text="Exportar a .PDF" />
                    <br />
                    <br />
                    <br />
